    ...
    <main className="flex min-h-screen flex-col items-center p-4 md:p-24 max-sm:m-12" id="howToUse">
      <div className="w-full md:w-[570px]">
        <h1 className="text-[44px] text-black font-extrabold text-center mb-2">
          <span className="text-violet-400">Easy steps to</span> remove an image
          background
        </h1>
      ...
      <div className="flex flex-col gap-6 mt-16 md:flex-row">
        <div className="w-full md:w-[370px] h-[180px] bg-[#F6F6F6] rounded-2xl p-6 flex gap-5">
          <h1 className="text-violet-400 font-extrabold text-[42px]">1</h1>
          <div>
        ...
        <div className="w-full md:w-[370px] h-[180px] bg-[#F6F6F6] rounded-2xl p-6 flex gap-5 mt-6 md:mt-0">
          <h1 className="text-violet-400 font-bold text-[42px]">2</h1>
          <div>
        ...
        <div className="w-full md:w-[370px] h-[180px] bg-[#F6F6F6] rounded-2xl p-6 flex gap-5 mt-6 md:mt-0">
          <h1 className="text-violet-400 font-extrabold text-[42px]">3</h1>
          <div>
